      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-foreground/70">Frontend Developer & Full-Stack Enthusiast</p>
          </div>
          ...
          <div className="space-y-4">
            <h4 className="font-semibold text-sm uppercase tracking-widest">Skills</h4>
            <ul className="space-y-2 text-sm">
              <li>
                <span className="text-foreground/70">React & Next.js</span>
              </li>
              <li>
                <span className="text-foreground/70">TypeScript</span>
              </li>
              <li>
                <span className="text-foreground/70">Full Stack Dev</span>
              </li>
              <li>
          ...
          <div className="space-y-4">
            <h4 className="font-semibold text-sm uppercase tracking-widest">Follow</h4>
